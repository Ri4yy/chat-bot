...
export default async function ProjectPage({
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-slate-900 dark:text-slate-50 flex flex-col relative overflow-hidden">
      {/* Квадратики на фоне */}
      ...
      <header className="border-b border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/80 backdrop-blur-md relative z-10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="text-sm font-medium text-slate-500 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white transition-colors">
              &larr; Назад к дашборду
            </Link>
            <div className="h-6 w-px bg-white dark:bg-zinc-800/50 border-slate-300 dark:border-zinc-700 text-slate-900 dark:text-slate-100"></div>
            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100">{project.name}</h1>
          </div>
          <HeaderProfile />
        </div>
      </header>
          ...
          <div className="md:col-span-1 space-y-4">
            <Card className="bg-white dark:bg-zinc-900 shadow-sm dark:shadow-none/50 shadow-sm dark:shadow-none border-slate-200 dark:border-zinc-800">
              ...
              <CardContent className="flex flex-col gap-2">
                ...
                <div className="text-xs font-semibold text-slate-500 dark:text-zinc-500 uppercase tracking-wider mt-2 mb-1 px-4">
                  Повседневная работа
                </div>
                ...
                {/* Секция: Обучение ИИ */}
                <div className="text-xs font-semibold text-slate-500 dark:text-zinc-500 uppercase tracking-wider mt-4 mb-1 px-4">
                  Обучение ИИ
                </div>
            ...
            {tab === 'dashboard' ? (
              ...
              <Card className="bg-white dark:bg-zinc-900 shadow-sm dark:shadow-none/50 shadow-sm dark:shadow-none border-slate-200 dark:border-zinc-800">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-slate-500 dark:text-zinc-500 mt-4">
