      ...
      <header className="border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-md relative z-10">
        <div className="container mx-auto px-4 py-3 min-h-[4rem] flex flex-wrap items-center justify-between gap-y-3 gap-x-4">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <h1 className="text-xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-400 whitespace-nowrap">
              Nexus AI
            </h1>
          </div>
      ...
      <main className="container mx-auto px-4 py-8 flex-1 relative z-10">
        <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-zinc-400 mt-1">Управляйте вашими виджетами и базами знаний ИИ.</p>
          </div>
