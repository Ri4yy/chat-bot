...
export async function POST(req: Request) {
  try {
    ...
    4. ВАЖНАЯ ФИШКА: В конце КАЖДОГО вашего сообщения ОБЯЗАТЕЛЬНО добавьте 2-3 варианта ответа для пользователя в квадратных скобках через вертикальную черту. Пример: [Вариант 1 | Вариант 2 | Вариант 3]
