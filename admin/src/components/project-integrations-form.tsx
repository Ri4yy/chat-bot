  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div className="space-y-4 border-t border-slate-200 dark:border-zinc-800 pt-6 pb-2">
        <div className="space-y-2">
          <Label htmlFor="b24_webhook_url" className="text-slate-500 dark:text-zinc-500 dark:text-slate-700 dark:text-zinc-300 font-semibold text-lg flex items-center gap-2">
            <Plug size={18} className="text-slate-500 dark:text-zinc-400" />
      ...
      <div className="space-y-4 border-t border-slate-200 dark:border-zinc-800 pt-6 pb-2">
        <div className="space-y-2">
          <Label htmlFor="amo_webhook_url" className="text-slate-500 dark:text-zinc-500 dark:text-slate-700 dark:text-zinc-300 font-semibold text-lg flex items-center gap-2">
            <Plug size={18} className="text-slate-500 dark:text-zinc-400" />
